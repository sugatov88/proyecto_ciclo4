...
export class AsesorAlquilerVehiculoController {
  ...
  async find(
    ...
    return this.asesorRepository.realiza(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.realiza(id).create(alquilerVehiculo);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.realiza(id).patch(alquilerVehiculo, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.realiza(id).delete(where);
  }
}
