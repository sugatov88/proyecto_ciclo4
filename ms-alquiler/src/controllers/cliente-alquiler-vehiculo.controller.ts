...
export class ClienteAlquilerVehiculoController {
  ...
  async find(
    ...
    return this.clienteRepository.alquilar(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.alquilar(id).create(alquilerVehiculo);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.alquilar(id).patch(alquilerVehiculo, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.alquilar(id).delete(where);
  }
}
